package com.acmenxd.mvpbase.db.core;
...
import com.acmenxd.mvpbase.db.dao.DaoMaster;
import com.acmenxd.mvpbase.db.migrator.BaseMigratorHelper;
            ...
            for (int i = oldVersion; i < newVersion; i++) {
                try {
                    BaseMigratorHelper migratorHelper = (BaseMigratorHelper) Class
                            .forName("com.acmenxd.mvpbase.db.migrator.MigratorHelper" + (i + 1)).newInstance();
