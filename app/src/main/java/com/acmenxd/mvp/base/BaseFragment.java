 ...
 * @detail Fragmeng基类
 */
public abstract class BaseFragment extends Fragment implements IActivityFragment {
    ...
    public final View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        // 设置默认的加载视图
        setLoadingView(BasisView.getLoadingView(mActivity));
        // 设置默认的错误视图
    ...
    /**
     * 子类创建视图请事情此函数, 勿使用onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
     */
    ...
    public final void showLoadingDialog(final boolean... setting) {
        ...
        mLoadingDialog.setContentView(BasisView.getDialogView(mActivity));
    ...
    public final void showContentView(boolean animat) {
        if (animat) {
            BasisView.layoutCancelInOutAnimation(mActivity, mContentLayout, mContentLayout, mLoadingLayout, mErrorLayout);
        } else {
    ...
    public final void showLoadingView(boolean animat) {
        if (animat) {
            BasisView.layoutCancelInOutAnimation(mActivity, mLoadingLayout, mContentLayout, mLoadingLayout, mErrorLayout);
        } else {
    ...
    public final void showErrorView(boolean animat) {
        if (animat) {
            BasisView.layoutCancelInOutAnimation(mActivity, mErrorLayout, mContentLayout, mLoadingLayout, mErrorLayout);
        } else {
