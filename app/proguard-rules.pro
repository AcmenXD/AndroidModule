...
#--------------------------------------------- 继承混淆类配置 ----------------------------------------#
-keep interface com.acmenxd.mvp.utils.proguard.** { *; }
-keep class * implements com.acmenxd.mvp.utils.proguard.IKeepClass
-keepnames class * implements com.acmenxd.mvp.utils.proguard.IKeepClassName
-keepclassmembers class * implements com.acmenxd.mvp.utils.proguard.IKeepFieldName {
    <fields>;
}
-keepclassmembers class * implements com.acmenxd.mvp.utils.proguard.IKeepPublicFieldName {
    public <fields>;
}
-keepclassmembers class * implements com.acmenxd.mvp.utils.proguard.IKeepMethodName {
    <methods>;
}
-keepclassmembers class * implements com.acmenxd.mvp.utils.proguard.IKeepPublicMethodName {
    public <methods>;
}
#--------------------------------------------- 继承类配置 End ----------------------------------------#
