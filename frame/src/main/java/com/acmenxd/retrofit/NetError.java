...
public final class NetError {
     ...
     * 异常状态码 -> 自定义异常
     */
    public static final int ERROR_RESPONSE = 7000; // 响应异常
    ...
    private static boolean checkNetWork() {
        ...
        ConnectivityManager connMgr = (ConnectivityManager) NetManager.INSTANCE.context.getSystemService(Context.CONNECTIVITY_SERVICE);
        if (connMgr == null) {
            return result;
        }
