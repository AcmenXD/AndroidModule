package com.acmenxd.appbase.db.core;
...
import com.acmenxd.appbase.db.dao.DaoMaster;
import com.acmenxd.appbase.db.migrator.BaseMigratorHelper;
            ...
            for (int i = oldVersion; i < newVersion; i++) {
                try {
                    BaseMigratorHelper migratorHelper = (BaseMigratorHelper) Class
                            .forName("com.acmenxd.appbase.db.migrator.MigratorHelper" + (i + 1)).newInstance();
