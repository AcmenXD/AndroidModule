            ...
            public View getGroupItemView(ViewGroup root, int groupLevel, int dataPosition) {
                ...
                if (datas.get(dataPosition).type == 3) {
                    if (dataPosition % 15 == 0) {
                        switch (groupLevel) {
                            case 0:
                                view = LayoutInflater.from(RecyclerActivity.this).inflate(R.layout.activity_recycler_group_item, root, false);
                                break;
                            case 1:
                                view = LayoutInflater.from(RecyclerActivity.this).inflate(R.layout.activity_recycler_group_item2, root, false);
                                break;
                            case 2:
                                view = LayoutInflater.from(RecyclerActivity.this).inflate(R.layout.activity_recycler_group_item3, root, false);
                                break;
                            case 3:
                                view = LayoutInflater.from(RecyclerActivity.this).inflate(R.layout.activity_recycler_group_item4, root, false);
                                break;
                        }
                    } else {
                        switch (groupLevel) {
